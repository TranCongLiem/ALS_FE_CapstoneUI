...
const factory GroupchatEvent.groupChatNameChanged(String groupChatName) =
  ...
  const factory GroupchatEvent.UpdatedLastMessageGroupChatRequest(String groupChatId,String lastMessageGroup,String userId) = _UpdatedLastMessageGroupChatRequest;
