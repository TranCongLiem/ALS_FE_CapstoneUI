...
class UserEvent with _$UserEvent {
  ...
  const factory UserEvent.updateInformationPatientRequest(String userId) = _UpdateInformationPatientRequest;
  const factory UserEvent.getProfileUserByIdRequest(String userId) = _GetProfileUserByIdRequest;
  ...
  const factory UserEvent.updateInformationPatientCheckRequested() = _UpdateInformationPatientCheckRequested;
  const factory UserEvent.setStateFlase() = _SetStateFlase;
  const factory UserEvent.setStateFlaseInformationPatient() = _SetStateFlaseInformationPatient;
}