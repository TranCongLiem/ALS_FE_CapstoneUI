...
class RegisterSupporter extends StatefulWidget {
  const RegisterSupporter({Key? key}) : super(key: key);

  @override
  State<RegisterSupporter> createState() => _RegisterSupporterState();
}

class _RegisterSupporterState extends State<RegisterSupporter> {
  @override
