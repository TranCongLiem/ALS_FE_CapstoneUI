...
import 'package:capstone_ui/Bloc/pushnotisupporter/push_noti_to_supporter_bloc.dart';
import 'package:capstone_ui/Feature/Chat/utils/utilities.dart';
...
class CustomSearchRecord extends StatefulWidget {
  final List<RecordById> references;
  final String userId;
  const CustomSearchRecord(
      {super.key, required this.references, required this.userId});

  @override
  State<CustomSearchRecord> createState() => _CustomSearchRecordState();
}

class _CustomSearchRecordState extends State<CustomSearchRecord> {
  late bool isPlaying;
