...
class CustomListUserGroupChat extends StatefulWidget {
  ...
  const CustomListUserGroupChat({super.key, required this.listGetAllUserInGroupChat});

  @override
  State<CustomListUserGroupChat> createState() => _CustomListUserGroupChatState();
}
...
class _CustomListUserGroupChatState extends State<CustomListUserGroupChat> {
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.listGetAllUserInGroupChat.joinTime != ''){
      time =
        DateTime.parse(widget.listGetAllUserInGroupChat.joinTime ?? '');
    }
